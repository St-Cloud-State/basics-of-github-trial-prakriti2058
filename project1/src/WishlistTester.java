...
public class WishlistTester {
    ...
    public static void main(String[] args) {
        ...
        // Test Client's built-in wishlist and waitlist functionality
        System.out.println("=== Testing Client's Built-in Wishlist/Waitlist ===");
        c1.addWishlistItem(p1);
        c1.addWishlistItem(p2);
        c1.addWaitlistItem(p3);
        
        System.out.println("Client 1's wishlist:");
        Iterator<ProductList> clientWishlist = c1.getWishlist();
        while (clientWishlist.hasNext()) {
            System.out.println("  - " + clientWishlist.next());
        }
        
        System.out.println("Client 1's waitlist:");
        Iterator<ProductList> clientWaitlist = c1.getWaitlist();
        while (clientWaitlist.hasNext()) {
            System.out.println("  - " + clientWaitlist.next());
        }
