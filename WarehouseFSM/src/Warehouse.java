...
public class Warehouse implements Serializable {
    ...
    public boolean processOrder(Client client) {
        ...
        while (wishlistIterator.hasNext()) {
            wishlist.add(wishlistIterator.next());
        }
    ...
    public Iterator<Product> getProducts() {
        return new ArrayList<>(products).iterator();
    }
    ...
    public Iterator<Client> getClients() {
        return new ArrayList<>(clients).iterator();
    }
    ...
    public void addProductQuantity(String productId, int quantity) {
        ...
        if (product != null) {
            ...
            Iterator<WaitlistItem> waitlist = product.getWaitlist();
            List<WaitlistItem> remainingItems = new ArrayList<>();
            int remainingQuantity = quantity;

            while (waitlist.hasNext()) {
                WaitlistItem item = waitlist.next();
    ...
    public Iterator<String> getInvoices(String clientId) {
        List<String> clientInvoices = invoices.get(clientId);
        return clientInvoices != null ? clientInvoices.iterator() : Collections.emptyIterator();
    }
